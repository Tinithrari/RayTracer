...
namespace LanceurRayon.Comparateur
{
	public class ImgUtility
	{
        ...
        { 
			...
			img_diff = new Bitmap (img1.Size.Width,img1.Size.Height);
			...
			for(y=0;y<img1.Size.Height;y++){
				for(x=0;x<img1.Size.Width;x++){
					...
					img_diff.SetPixel(x,y, Color.FromArgb(Math.Abs(couleur_img1.R-couleur_img2.R),
